...
gem install lolcat
clear
toilet -f mono12 -F gay -t 'K S L' | lolcat -a -d 1
toilet -f wideterm -F border:gay -t ' KSL_GAMING ' | lolcat -a -d 1
echo ""
toilet -f wideterm -F border:gay -t 'GLOBAL BYPASS' | lolcat -a -d 3
echo""
toilet -f term -F metal " ▶️START RUN PUBG▶️ "
am start -n com.tencent.ig/com.epicgames.ue4.SplashActivity
sleep 10
cp /data/data/com.termux/files/home/Bypass /storage/emulated/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.16.0.11462.pak
cp /data/data/com.termux/files/home/KSL_ANTIBAN /data/data/com.tencent.ig/databases/SUDO_ONLINE
cp /data/data/com.termux/files/home/KSL_ANTIBAN /data/data/com.tencent.ig/files/SUDO_ONLINE
chmod -R 660 /data/data/com.tencent.ig/databases/SUDO_ONLINE
chmod -R 660 /data/data/com.tencent.ig/files/SUDO_ONLINE
...
rm -rf /data/data/com.tencent.ig/databases/bugly_db_-shm
rm -rf /data/data/com.tencent.ig/databases/bugly_db_-wal
rm -rf /data/data/com.tencent.ig/files/__tsecache.dat
rm -rf /data/data/com.tencent.ig/files/gcTestConfig.txt
rm -rf /data/data/com.tencent.ig/files/hawk_data
rm -rf /data/data/com.tencent.ig/files/hawk_data_init
rm -rf /data/data/com.tencent.ig/files/TAPM_CM_AUDIT
...
rm -rf /storage/emulated/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/1375135419_47_0.16.0.11466_20191217120416_135842427_cures.ifs.cures
rm -rf /storage/emulated/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/1375135419_47_0.16.0.11466_20191217120416_135842427_cures.ifs.res
...
toilet -f wideterm -F border -t ' Start Restore Pubg Data ' | lolcat -a -d 5
echo ""
pm install -r /data/app/com.tencent.ig*/base.apk
rm -rf /storage/emulated/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.16.0.11462.pak
rm -rf /data/data/com.tencent.ig/databases/SUDO_ONLINE
rm -rf /data/data/com.tencent.ig/files/SUDO_ONLINE
su -c iptables --flush
toilet -f term -F metal:border ' contacts ph-09450885066!'
echo ""
toilet -f term -F border:gay -t 'Telegram : t.me/kosarlay'
echo ""
toilet -f term -F border:gay -t 'Everything Restored...' | lolcat -a -d 1
rm -rf /data/data/com.termux/files/home/KSL/lolcat-master/
rm -rf /data/data/com.termux/files/home/KSL/master.zip
echo "DONE"
